 ...
 <section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="text">Passengers</div>
                                <select class="form-control show-tick" name="passenger" id="passenger" data-live-search="true" style="color:black;">
                                        <option value="">[ Pick here ]</option>
                                        @for($x = 1;$x<8;$x++)
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="text">PROCESS</div>
                               <button type="button" class="form-control btn btn-default" id="cariRute_multi">SEARCH</button>
                    </div>
